defmodule ExMon.Game do
  ...
  def start(computer, player) do
    initial_valeu = %{computer: computer, player: player, turn: :player, status: :started}
    Agent.start_link(fn -> initial_valeu end, name: __MODULE__)
  end
  ...
  defp update_game_status(
    ...
    do: Map.put(state, :status, :gamer_over)
